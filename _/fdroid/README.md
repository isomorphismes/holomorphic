...
The Android project can produce the unsigned release APK F-Droid expects without Play signing secrets or the repository's legacy development sideload key.
